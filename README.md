...
> 当前 Jonoka 发版：**[v0.2.1-jonoka](docs/releases/v0.2.1-jonoka.md)**（+ 图谱 HTML 记批注）· [v0.2.0-jonoka](docs/releases/v0.2.0-jonoka.md) · [v0.1.3-jonoka](https://github.com/Jonoka/llm-wiki-skill/releases/tag/v0.1.3-jonoka)
...
- **可恢复 Audit 纠错** — target 严格限制在 vault 内 `wiki/*.md`；正文修正只走「处理批注」的无覆盖、可重试 accept
